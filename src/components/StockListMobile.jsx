        ...
        >
          ...
          >
            ...
            <div className="flex justify-between items-center w-[85%] h-full py-3 px-2 pr-4">
              ...
              <div className="flex items-center gap-3 text-lg justify-around w-[50%]">
                ...
                <div className="flex items-center gap-1">
                  ...
                  {isEditing ? (
                    <input
                      ...
                      onChange={(e) =>
                        handleChange(stock.ID_stock, "Quantity", e.target.value)
                      }
              ...
              <div className="flex items-center gap-2">
                ...
                {isEditing ? (
                  <input
                    ...
                    onChange={(e) =>
                      handleChange(stock.ID_stock, "Nmb_boxes", e.target.value)
                    }
                    className="w-[50px] text-center border border-gray-300 rounded C-text-black font-bold"
                  />
                ) : (
