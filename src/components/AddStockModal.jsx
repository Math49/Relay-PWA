        ...
        {!showNewProductForm ? (
            ...
            >
              ...
              >
                <div className="flex items-center justify-center h-full gap-3 border-r-black border-r-[1px] w-[15%]">
                  <img
                    src={
                      !selectedProduct.Image || "/images/elements/default-product.jpg"
                    }
              ...
              <div
              className="bg-white w-[90%] h-[5vh] rounded-[10px] border-[2px] C-border-red overflow-hidden transition-all duration-300"
            >
            </div>
            )
            }
                      ...
                      >
                        ...
                        >
                          <div className="flex items-center justify-center h-full gap-3 border-r-black border-r-[1px] w-[15%]">
                            <img
                              src={
                                !p.Image || "/images/elements/default-product.jpg"
                              }
                              alt={p?.Label}
                              className="w-auto h-full rounded-[10px] object-cover"
                            />
          ...
          <div className="flex items-center justify-around w-full">
            <div className="flex items-center gap-2">
              ...
              <input
                    type="number"
                    value={selectedProduct?.Box_quantity}
                    className="w-[50px] text-center border-[2px] C-border-red-var2 rounded C-text-black font-bold"
                  />
            </div>
            <button className=" C-text-white font-bold text-xl cursor-pointer C-bg-red rounded-full px-10 py-2">
              Ajouter
            </button>
          </div>
          </>
