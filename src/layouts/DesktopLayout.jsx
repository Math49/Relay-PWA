...
export default function DesktopLayout({ children, title, city }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center C-bg-red w-[100vw] h-[100vh] overflow-hidden">
      ...
      <div className="flex items-start justify-center w-[100vw] h-[100%]">
        <div className="flex flex-col items-start justify-center w-[15vw] h-[100%] rounded-r-[40px] relative z-20">
          <div className="flex flex-col items-center justify-center w-[100%] h-[95%] C-bg-white rounded-l-[40px] relative z-20 pt-[5vh]">
            <NavMenu/>
          </div>
          <div className="C-bg-white h-[7%] w-[100%]">
        ...
        <div className="flex flex-col items-center justify-center w-[100vw] h-[100%] C-bg-white rounded-se-[40px]  rounded-bl-[40px] relative z-20">
          {children}
        </div>
      </div>
    </div>
